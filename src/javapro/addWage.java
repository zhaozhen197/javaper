 ...
 */
public class addWage extends JFrame implements ActionListener  {
        ...
        if (e.getSource() == getAdd())// 判断触发源是否是按钮1
        {
            ...
            if (getNumLabel_jtf().getText() != null) {
                ...
                total = welfare + jobSalary + baseSalary;
                    ...
                    Statement stmt = null;
                    String sql;//sql语句
                        sql = "INSERT INTO salary(id,name,basesalary,jobsalary,welfare,total)" + "VALUES('" + num + "','" + name + "','" + baseSalary + "','" + jobSalary + "','"+welfare+"','"+ total+"')";
                    try {
